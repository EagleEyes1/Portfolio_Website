        ...
        <Col lg={6} md={12} sm={12} className={styles.colcontent}>
          ...
          <div className={styles.cvbutton} data-aos="fade-right">
            <Button
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/13kQmkvTp0Ok5DYRFW9YlPSRg0_Fffp_Z/view?usp=sharing",
                  "rel=noopener noreferrer"
                )
              }
              variant="primary"
            ...
            <Button
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/13RZqZF5T763M9zoPplMnJQKz5TC_Lntm/view?usp=sharing",
                  "rel=noopener noreferrer"
                )
              }
              variant="primary"
