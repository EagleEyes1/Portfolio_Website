        ...
        <Col lg={6} md={12} sm={12} className={styles.colcontent}>
          ...
          <div className={styles.cvbutton} data-aos="fade-right">
            <Button
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/1hR1zHnLbgUazfLCKtvOao19bqfME09aK/view?usp=sharing",
                  "rel=noopener noreferrer"
                )
              }
              variant="primary"
            ...
            <Button
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/1pSmkNP69TGMxTZ1N---mH1VHwarZzT7l/view?usp=sharing",
                  "rel=noopener noreferrer"
                )
              }
              variant="primary"
